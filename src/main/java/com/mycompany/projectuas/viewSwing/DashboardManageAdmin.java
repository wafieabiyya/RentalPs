 ...
 * @author user
 */
public class DashboardManageAdmin extends javax.swing.JFrame {

    /**
     * Creates new form Dashboard
     */
    public DashboardManageAdmin() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton2.setBackground(new java.awt.Color(214, 228, 229));
        ...
        jLabel1.setText("Welcome to Admin Management Page");
        jPanel3.add(jLabel1);
        jLabel1.setBounds(130, 10, 480, 30);

        jLabel5.setFont(new java.awt.Font("Segoe UI Light", 0, 16)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("This page is management Admin. here there is admin can control rental ps");
        jPanel3.add(jLabel5);
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Admin_ID", "Admin_Name", "Description"
            }
        ));
        ...
        jTextField4.setText("Input Admin_ID");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DashboardManageAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DashboardManageAdmin().setVisible(true);
            }
        });
    }
